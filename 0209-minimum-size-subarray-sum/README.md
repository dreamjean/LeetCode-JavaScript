...
<pre class="notranslate"><strong>Input:</strong> target = 7, nums = [2,3,1,2,4,3]
...
<pre class="notranslate"><strong>Input:</strong> target = 4, nums = [1,4,4]
<strong>Output:</strong> 1
</pre>

<p><strong class="example">Example 3:</strong></p>

<pre class="notranslate"><strong>Input:</strong> target = 11, nums = [1,1,1,1,1,1,1,1]
