...
<pre class="notranslate"><strong>Input:</strong> people = [1,2], limit = 3
...
<pre class="notranslate"><strong>Input:</strong> people = [3,2,2,1], limit = 3
...
<pre class="notranslate"><strong>Input:</strong> people = [3,5,3,4], limit = 5
